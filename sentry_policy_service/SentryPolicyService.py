...
class Iface(object):
    ...
    def alter_sentry_role_add_users(self, request):
        """
        Parameters:
         - request
        """
    ...
    def alter_sentry_role_delete_users(self, request):
        """
        Parameters:
         - request
        """
    ...
    def list_sentry_roles_by_user(self, request):
        """
        Parameters:
         - request
        """
    ...
    def list_sentry_privileges_by_user(self, request):
        """
        Parameters:
         - request
        """
    ...
    def list_sentry_privileges_by_user_and_itsgroups(self, request):
        """
        Parameters:
         - request
        """
    ...
    def export_sentry_mapping_data(self, request):
        """
        Parameters:
         - request
        """
    ...
    def import_sentry_mapping_data(self, request):
        """
        Parameters:
         - request
        """
    ...
    def sentry_sync_notifications(self, request):
        """
        Parameters:
         - request
        """
    ...
    def sentry_notify_hms_event(self, request):
        """
        Parameters:
         - request
        """
    ...
    def list_roles_privileges(self, request):
        """
        Parameters:
         - request
        """
    ...
    def list_users_privileges(self, request):
        """
        Parameters:
         - request
        """
...
class Client(Iface):
    ...
    def alter_sentry_role_add_users(self, request):
        ...
        Parameters:
         - request
        """
        self.send_alter_sentry_role_add_users(request)
        return self.recv_alter_sentry_role_add_users()

    def send_alter_sentry_role_add_users(self, request):
        self._oprot.writeMessageBegin('alter_sentry_role_add_users', TMessageType.CALL, self._seqid)
        args = alter_sentry_role_add_users_args()
        args.request = request
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_alter_sentry_role_add_users(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = alter_sentry_role_add_users_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "alter_sentry_role_add_users failed: unknown result")
    ...
    def alter_sentry_role_delete_users(self, request):
        ...
        Parameters:
         - request
        """
        self.send_alter_sentry_role_delete_users(request)
        return self.recv_alter_sentry_role_delete_users()

    def send_alter_sentry_role_delete_users(self, request):
        self._oprot.writeMessageBegin('alter_sentry_role_delete_users', TMessageType.CALL, self._seqid)
        args = alter_sentry_role_delete_users_args()
        args.request = request
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_alter_sentry_role_delete_users(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = alter_sentry_role_delete_users_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "alter_sentry_role_delete_users failed: unknown result")
    ...
    def list_sentry_roles_by_user(self, request):
        ...
        Parameters:
         - request
        """
        self.send_list_sentry_roles_by_user(request)
        return self.recv_list_sentry_roles_by_user()

    def send_list_sentry_roles_by_user(self, request):
        self._oprot.writeMessageBegin('list_sentry_roles_by_user', TMessageType.CALL, self._seqid)
        args = list_sentry_roles_by_user_args()
        args.request = request
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_list_sentry_roles_by_user(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = list_sentry_roles_by_user_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "list_sentry_roles_by_user failed: unknown result")
    ...
    def list_sentry_privileges_by_user(self, request):
        ...
        Parameters:
         - request
        """
        self.send_list_sentry_privileges_by_user(request)
        return self.recv_list_sentry_privileges_by_user()

    def send_list_sentry_privileges_by_user(self, request):
        self._oprot.writeMessageBegin('list_sentry_privileges_by_user', TMessageType.CALL, self._seqid)
        args = list_sentry_privileges_by_user_args()
        args.request = request
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_list_sentry_privileges_by_user(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = list_sentry_privileges_by_user_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "list_sentry_privileges_by_user failed: unknown result")
    ...
    def list_sentry_privileges_by_user_and_itsgroups(self, request):
        ...
        Parameters:
         - request
        """
        self.send_list_sentry_privileges_by_user_and_itsgroups(request)
        return self.recv_list_sentry_privileges_by_user_and_itsgroups()

    def send_list_sentry_privileges_by_user_and_itsgroups(self, request):
        self._oprot.writeMessageBegin('list_sentry_privileges_by_user_and_itsgroups', TMessageType.CALL, self._seqid)
        args = list_sentry_privileges_by_user_and_itsgroups_args()
        args.request = request
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_list_sentry_privileges_by_user_and_itsgroups(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = list_sentry_privileges_by_user_and_itsgroups_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "list_sentry_privileges_by_user_and_itsgroups failed: unknown result")
    ...
    def export_sentry_mapping_data(self, request):
        ...
        Parameters:
         - request
        """
        self.send_export_sentry_mapping_data(request)
        return self.recv_export_sentry_mapping_data()

    def send_export_sentry_mapping_data(self, request):
        self._oprot.writeMessageBegin('export_sentry_mapping_data', TMessageType.CALL, self._seqid)
        args = export_sentry_mapping_data_args()
        args.request = request
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_export_sentry_mapping_data(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = export_sentry_mapping_data_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "export_sentry_mapping_data failed: unknown result")
    ...
    def import_sentry_mapping_data(self, request):
        ...
        Parameters:
         - request
        """
        self.send_import_sentry_mapping_data(request)
        return self.recv_import_sentry_mapping_data()

    def send_import_sentry_mapping_data(self, request):
        self._oprot.writeMessageBegin('import_sentry_mapping_data', TMessageType.CALL, self._seqid)
        args = import_sentry_mapping_data_args()
        args.request = request
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_import_sentry_mapping_data(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = import_sentry_mapping_data_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "import_sentry_mapping_data failed: unknown result")
    ...
    def sentry_sync_notifications(self, request):
        ...
        Parameters:
         - request
        """
        self.send_sentry_sync_notifications(request)
        return self.recv_sentry_sync_notifications()

    def send_sentry_sync_notifications(self, request):
        self._oprot.writeMessageBegin('sentry_sync_notifications', TMessageType.CALL, self._seqid)
        args = sentry_sync_notifications_args()
        args.request = request
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_sentry_sync_notifications(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = sentry_sync_notifications_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "sentry_sync_notifications failed: unknown result")
    ...
    def sentry_notify_hms_event(self, request):
        ...
        Parameters:
         - request
        """
        self.send_sentry_notify_hms_event(request)
        return self.recv_sentry_notify_hms_event()

    def send_sentry_notify_hms_event(self, request):
        self._oprot.writeMessageBegin('sentry_notify_hms_event', TMessageType.CALL, self._seqid)
        args = sentry_notify_hms_event_args()
        args.request = request
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_sentry_notify_hms_event(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = sentry_notify_hms_event_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "sentry_notify_hms_event failed: unknown result")
    ...
    def list_roles_privileges(self, request):
        ...
        Parameters:
         - request
        """
        self.send_list_roles_privileges(request)
        return self.recv_list_roles_privileges()

    def send_list_roles_privileges(self, request):
        self._oprot.writeMessageBegin('list_roles_privileges', TMessageType.CALL, self._seqid)
        args = list_roles_privileges_args()
        args.request = request
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_list_roles_privileges(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = list_roles_privileges_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "list_roles_privileges failed: unknown result")
    ...
    def list_users_privileges(self, request):
        ...
        Parameters:
         - request
        """
        self.send_list_users_privileges(request)
        return self.recv_list_users_privileges()

    def send_list_users_privileges(self, request):
        self._oprot.writeMessageBegin('list_users_privileges', TMessageType.CALL, self._seqid)
        args = list_users_privileges_args()
        args.request = request
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_list_users_privileges(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = list_users_privileges_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "list_users_privileges failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["alter_sentry_role_add_users"] = Processor.process_alter_sentry_role_add_users
        self._processMap["alter_sentry_role_delete_users"] = Processor.process_alter_sentry_role_delete_users
        self._processMap["list_sentry_roles_by_group"] = Processor.process_list_sentry_roles_by_group
        self._processMap["list_sentry_roles_by_user"] = Processor.process_list_sentry_roles_by_user
        self._processMap["list_sentry_privileges_by_role"] = Processor.process_list_sentry_privileges_by_role
        self._processMap["list_sentry_privileges_by_user"] = Processor.process_list_sentry_privileges_by_user
        self._processMap["list_sentry_privileges_by_user_and_itsgroups"] = Processor.process_list_sentry_privileges_by_user_and_itsgroups
        ...
        self._processMap["export_sentry_mapping_data"] = Processor.process_export_sentry_mapping_data
        self._processMap["import_sentry_mapping_data"] = Processor.process_import_sentry_mapping_data
        self._processMap["sentry_sync_notifications"] = Processor.process_sentry_sync_notifications
        self._processMap["sentry_notify_hms_event"] = Processor.process_sentry_notify_hms_event
        self._processMap["list_roles_privileges"] = Processor.process_list_roles_privileges
        self._processMap["list_users_privileges"] = Processor.process_list_users_privileges
    ...
    def process_alter_sentry_role_add_users(self, seqid, iprot, oprot):
        args = alter_sentry_role_add_users_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = alter_sentry_role_add_users_result()
        try:
            result.success = self._handler.alter_sentry_role_add_users(args.request)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("alter_sentry_role_add_users", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_alter_sentry_role_delete_users(self, seqid, iprot, oprot):
        args = alter_sentry_role_delete_users_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = alter_sentry_role_delete_users_result()
        try:
            result.success = self._handler.alter_sentry_role_delete_users(args.request)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("alter_sentry_role_delete_users", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_list_sentry_roles_by_user(self, seqid, iprot, oprot):
        args = list_sentry_roles_by_user_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = list_sentry_roles_by_user_result()
        try:
            result.success = self._handler.list_sentry_roles_by_user(args.request)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("list_sentry_roles_by_user", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_list_sentry_privileges_by_user(self, seqid, iprot, oprot):
        args = list_sentry_privileges_by_user_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = list_sentry_privileges_by_user_result()
        try:
            result.success = self._handler.list_sentry_privileges_by_user(args.request)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("list_sentry_privileges_by_user", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_list_sentry_privileges_by_user_and_itsgroups(self, seqid, iprot, oprot):
        args = list_sentry_privileges_by_user_and_itsgroups_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = list_sentry_privileges_by_user_and_itsgroups_result()
        try:
            result.success = self._handler.list_sentry_privileges_by_user_and_itsgroups(args.request)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("list_sentry_privileges_by_user_and_itsgroups", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_export_sentry_mapping_data(self, seqid, iprot, oprot):
        args = export_sentry_mapping_data_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = export_sentry_mapping_data_result()
        try:
            result.success = self._handler.export_sentry_mapping_data(args.request)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("export_sentry_mapping_data", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_import_sentry_mapping_data(self, seqid, iprot, oprot):
        args = import_sentry_mapping_data_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = import_sentry_mapping_data_result()
        try:
            result.success = self._handler.import_sentry_mapping_data(args.request)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("import_sentry_mapping_data", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_sentry_sync_notifications(self, seqid, iprot, oprot):
        args = sentry_sync_notifications_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = sentry_sync_notifications_result()
        try:
            result.success = self._handler.sentry_sync_notifications(args.request)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("sentry_sync_notifications", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_sentry_notify_hms_event(self, seqid, iprot, oprot):
        args = sentry_notify_hms_event_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = sentry_notify_hms_event_result()
        try:
            result.success = self._handler.sentry_notify_hms_event(args.request)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("sentry_notify_hms_event", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_list_roles_privileges(self, seqid, iprot, oprot):
        args = list_roles_privileges_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = list_roles_privileges_result()
        try:
            result.success = self._handler.list_roles_privileges(args.request)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("list_roles_privileges", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_list_users_privileges(self, seqid, iprot, oprot):
        args = list_users_privileges_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = list_users_privileges_result()
        try:
            result.success = self._handler.list_users_privileges(args.request)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("list_users_privileges", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class alter_sentry_role_add_users_args(object):
    """
    Attributes:
     - request
    """
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.request = TAlterSentryRoleAddUsersRequest()
                    self.request.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('alter_sentry_role_add_users_args')
        if self.request is not None:
            oprot.writeFieldBegin('request', TType.STRUCT, 1)
            self.request.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(alter_sentry_role_add_users_args)
alter_sentry_role_add_users_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [TAlterSentryRoleAddUsersRequest, None], None, ),  # 1
)


class alter_sentry_role_add_users_result(object):
    """
    Attributes:
     - success
    """
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = TAlterSentryRoleAddUsersResponse()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('alter_sentry_role_add_users_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(alter_sentry_role_add_users_result)
alter_sentry_role_add_users_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [TAlterSentryRoleAddUsersResponse, None], None, ),  # 0
)


class alter_sentry_role_delete_users_args(object):
    """
    Attributes:
     - request
    """
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.request = TAlterSentryRoleDeleteUsersRequest()
                    self.request.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('alter_sentry_role_delete_users_args')
        if self.request is not None:
            oprot.writeFieldBegin('request', TType.STRUCT, 1)
            self.request.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(alter_sentry_role_delete_users_args)
alter_sentry_role_delete_users_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [TAlterSentryRoleDeleteUsersRequest, None], None, ),  # 1
)


class alter_sentry_role_delete_users_result(object):
    """
    Attributes:
     - success
    """
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = TAlterSentryRoleDeleteUsersResponse()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('alter_sentry_role_delete_users_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(alter_sentry_role_delete_users_result)
alter_sentry_role_delete_users_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [TAlterSentryRoleDeleteUsersResponse, None], None, ),  # 0
)
...
class list_sentry_roles_by_user_args(object):
    """
    Attributes:
     - request
    """
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.request = TListSentryRolesForUserRequest()
                    self.request.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('list_sentry_roles_by_user_args')
        if self.request is not None:
            oprot.writeFieldBegin('request', TType.STRUCT, 1)
            self.request.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(list_sentry_roles_by_user_args)
list_sentry_roles_by_user_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [TListSentryRolesForUserRequest, None], None, ),  # 1
)


class list_sentry_roles_by_user_result(object):
    """
    Attributes:
     - success
    """
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('list_sentry_roles_by_user_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(list_sentry_roles_by_user_result)
list_sentry_roles_by_user_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [TListSentryRolesResponse, None], None, ),  # 0
)
...
class list_sentry_privileges_by_user_args(object):
    """
    Attributes:
     - request
    """
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('list_sentry_privileges_by_user_args')
        if self.request is not None:
            oprot.writeFieldBegin('request', TType.STRUCT, 1)
            self.request.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(list_sentry_privileges_by_user_args)
list_sentry_privileges_by_user_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [TListSentryPrivilegesRequest, None], None, ),  # 1
)


class list_sentry_privileges_by_user_result(object):
    """
    Attributes:
     - success
    """
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('list_sentry_privileges_by_user_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(list_sentry_privileges_by_user_result)
list_sentry_privileges_by_user_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [TListSentryPrivilegesResponse, None], None, ),  # 0
)


class list_sentry_privileges_by_user_and_itsgroups_args(object):
    """
    Attributes:
     - request
    """
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('list_sentry_privileges_by_user_and_itsgroups_args')
        if self.request is not None:
            oprot.writeFieldBegin('request', TType.STRUCT, 1)
            self.request.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(list_sentry_privileges_by_user_and_itsgroups_args)
list_sentry_privileges_by_user_and_itsgroups_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [TListSentryPrivilegesRequest, None], None, ),  # 1
)


class list_sentry_privileges_by_user_and_itsgroups_result(object):
    """
    Attributes:
     - success
    """
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('list_sentry_privileges_by_user_and_itsgroups_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(list_sentry_privileges_by_user_and_itsgroups_result)
list_sentry_privileges_by_user_and_itsgroups_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [TListSentryPrivilegesResponse, None], None, ),  # 0
)
...
class export_sentry_mapping_data_args(object):
    """
    Attributes:
     - request
    """
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.request = TSentryExportMappingDataRequest()
                    self.request.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('export_sentry_mapping_data_args')
        if self.request is not None:
            oprot.writeFieldBegin('request', TType.STRUCT, 1)
            self.request.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(export_sentry_mapping_data_args)
export_sentry_mapping_data_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [TSentryExportMappingDataRequest, None], None, ),  # 1
)


class export_sentry_mapping_data_result(object):
    """
    Attributes:
     - success
    """
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = TSentryExportMappingDataResponse()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('export_sentry_mapping_data_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(export_sentry_mapping_data_result)
export_sentry_mapping_data_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [TSentryExportMappingDataResponse, None], None, ),  # 0
)


class import_sentry_mapping_data_args(object):
    """
    Attributes:
     - request
    """
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.request = TSentryImportMappingDataRequest()
                    self.request.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('import_sentry_mapping_data_args')
        if self.request is not None:
            oprot.writeFieldBegin('request', TType.STRUCT, 1)
            self.request.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(import_sentry_mapping_data_args)
import_sentry_mapping_data_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [TSentryImportMappingDataRequest, None], None, ),  # 1
)


class import_sentry_mapping_data_result(object):
    """
    Attributes:
     - success
    """
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = TSentryImportMappingDataResponse()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('import_sentry_mapping_data_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(import_sentry_mapping_data_result)
import_sentry_mapping_data_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [TSentryImportMappingDataResponse, None], None, ),  # 0
)


class sentry_sync_notifications_args(object):
    """
    Attributes:
     - request
    """
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.request = TSentrySyncIDRequest()
                    self.request.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('sentry_sync_notifications_args')
        if self.request is not None:
            oprot.writeFieldBegin('request', TType.STRUCT, 1)
            self.request.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(sentry_sync_notifications_args)
sentry_sync_notifications_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [TSentrySyncIDRequest, None], None, ),  # 1
)


class sentry_sync_notifications_result(object):
    """
    Attributes:
     - success
    """
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = TSentrySyncIDResponse()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('sentry_sync_notifications_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(sentry_sync_notifications_result)
sentry_sync_notifications_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [TSentrySyncIDResponse, None], None, ),  # 0
)


class sentry_notify_hms_event_args(object):
    """
    Attributes:
     - request
    """
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.request = TSentryHmsEventNotification()
                    self.request.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('sentry_notify_hms_event_args')
        if self.request is not None:
            oprot.writeFieldBegin('request', TType.STRUCT, 1)
            self.request.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(sentry_notify_hms_event_args)
sentry_notify_hms_event_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [TSentryHmsEventNotification, None], None, ),  # 1
)


class sentry_notify_hms_event_result(object):
    """
    Attributes:
     - success
    """
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = TSentryHmsEventNotificationResponse()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('sentry_notify_hms_event_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(sentry_notify_hms_event_result)
sentry_notify_hms_event_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [TSentryHmsEventNotificationResponse, None], None, ),  # 0
)


class list_roles_privileges_args(object):
    """
    Attributes:
     - request
    """
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.request = TSentryPrivilegesRequest()
                    self.request.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('list_roles_privileges_args')
        if self.request is not None:
            oprot.writeFieldBegin('request', TType.STRUCT, 1)
            self.request.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(list_roles_privileges_args)
list_roles_privileges_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [TSentryPrivilegesRequest, None], None, ),  # 1
)


class list_roles_privileges_result(object):
    """
    Attributes:
     - success
    """
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = TSentryPrivilegesResponse()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('list_roles_privileges_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(list_roles_privileges_result)
list_roles_privileges_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [TSentryPrivilegesResponse, None], None, ),  # 0
)


class list_users_privileges_args(object):
    """
    Attributes:
     - request
    """
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('list_users_privileges_args')
        if self.request is not None:
            oprot.writeFieldBegin('request', TType.STRUCT, 1)
            self.request.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(list_users_privileges_args)
list_users_privileges_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [TSentryPrivilegesRequest, None], None, ),  # 1
)


class list_users_privileges_result(object):
    """
    Attributes:
     - success
    """
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('list_users_privileges_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(list_users_privileges_result)
list_users_privileges_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [TSentryPrivilegesResponse, None], None, ),  # 0
)
