...
class sentry_sync_notifications_args(object):
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'request', (TSentrySyncIDRequest, TSentrySyncIDRequest.thrift_spec), None, ), # 1
  )
...
class sentry_sync_notifications_result(object):
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (TSentrySyncIDResponse, TSentrySyncIDResponse.thrift_spec), None, ), # 0
  )
